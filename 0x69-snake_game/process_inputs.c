...
{
	if (e.key.keysym.sym == SDLK_UP && !its_heading("down"))
		set_snake_heading("up");

	if (e.key.keysym.sym == SDLK_DOWN && !its_heading("up"))
		set_snake_heading("down");

	if (e.key.keysym.sym == SDLK_LEFT && !its_heading("right"))
		set_snake_heading("left");

	if (e.key.keysym.sym == SDLK_RIGHT && !its_heading("left"))
